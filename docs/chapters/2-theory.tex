...
Esses modelos são baseados em transformadores, uma arquitetura de rede neural proposta por \textcite{transformers_the_og}, originalmente para realizar traduções entre
idiomas.
