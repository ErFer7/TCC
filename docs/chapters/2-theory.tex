...
\begin{figure}[ht]
      ...
      \caption{\small Estrutura de um \ac{MLLM} que realiza apenas a interpretação multimodal. Fonte: Autoria própria.}
...
valores em \ac{NF4} são convertidos para \ac{BF16} durante os cálculos. Além disso, também são usados otimizadores paginados e dupla quantização.
